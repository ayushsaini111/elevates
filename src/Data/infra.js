...
export const infraData = {
  hero: {
    ...
    subtitle3: "Societies",
    backgroundImage: "/Infra/hero-bg.png",   // grid background
    foregroundImage: "/Infra/hero-shape.jpg", // blue pattern
  },
  philosophy: {
    tagline:
  ...
  process: {
    ...
    steps: [
      {
        id: "01",
        prefix: "Project begins with",
        highlight: "Site Assessment & Viability",
        suffix: "for optimal outcomes.",
